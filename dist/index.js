...
var ReactDadataFio = /** @class */ (function (_super) {
    ...
    function ReactDadataFio(props) {
        ...
        _this.fetchSuggestions = function () {
            ...
            _this.xhr.open("POST", "https://suggestions.dadata.ru/suggestions/api/4_1/rs/suggest/fio?5");
    ...
    ReactDadataFio.prototype.componentDidMount = function () {
        if (this.props.autoload && this.state.query) {
            this.fetchSuggestions();
        }
    };
    ;
    ReactDadataFio.prototype.render = function () {
        var _this = this;
    ...
    return ReactDadataFio;
}(React.PureComponent));
exports.ReactDadataFio = ReactDadataFio;
